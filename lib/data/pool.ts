...
import { isPickLocked, isPickRevealed } from "@/lib/domain/deadlines";
...
type LineRow = { game_id: string; underdog_team_id: string; favorite_team_id: string; underdog_spread: number | string };

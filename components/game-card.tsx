...
import { formatEastern, isPickLocked, type NflWeekWindow } from "@/lib/domain/deadlines";
import { Button, Card, Pill } from "./ui";

export function UnderdogPickCard({ game, week, onPick }: { game: PoolGame; week: NflWeekWindow; onPick: (game: PoolGame) => void }) {
  ...
  const locked = isPickLocked(new Date(game.kickoff), week, new Date("2026-10-14T18:00:00Z"));
